...
namespace Compress.ZipFile
{
    public partial class Zip
    {
        ...
        private void EndOfCentralDirWrite()
        {
            ...
            bw.Write((ushort)(_HeadersCentralDir.Count >= 0xffff ? 0xffff : _HeadersCentralDir.Count)); // TotalNumberOfEntriesDisk
            bw.Write((ushort)(_HeadersCentralDir.Count >= 0xffff ? 0xffff : _HeadersCentralDir.Count)); // TotalNumber of entries in the central directory 
        ...
        private void Zip64EndOfCentralDirWrite()
        {
            ...
            bw.Write((ulong)_HeadersCentralDir.Count); // total number of entries in the central directory on this disk
            bw.Write((ulong)_HeadersCentralDir.Count); // total number of entries in the central directory
